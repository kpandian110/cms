...
@extends('layouts.plane')
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">Skylink Fibernet</a>
            </div>
 <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                       <!-- <li class="sidebar-search">
                        ...
                        <li {{ (Request::is('/') ? 'class="active"' : '') }}>
                            <a href="{{ url ('') }}"><i class="fa fa-dashboard fa-fw"></i> Admin</a>
                        </li>
                        <li {{ (Request::is('*calls') ? 'class=""' : '') }}>
                            <a href="{{ url ('calls') }}"><i class="fa fa-phone"></i> Active Calls</a>
                            <!-- /.nav-second-level -->
                        </li>
